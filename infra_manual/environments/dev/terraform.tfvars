...
codepipeline_tf_push_name                     = "codepipeline-tf-push-dev"
...
codepipeline_tf_push_stages = [
  ...
  #   name = "Install"
  #   action = [{
  #     name             = "tf_install_dotnet"
  #     category         = "Build"
  #     owner            = "AWS"
  #     provider         = "CodeBuild"
  #     input_artifacts  = ["SourceOutput"]
  #     output_artifacts = ["DotnetInstalled"]
  #     version          = "1"
  #     run_order        = 1
  #     configuration = {
  #       ProjectName = "codebuild-tf-install_dotnet"
  #     }
  #   }]
  # },
  # {
...
codepipeline_tf_push_trigger_git_conf_push_file_paths_includes         = ["infra/infra_auto/environments/dev/*", "infra/infra_auto/environment_template/*", "infra/infra_auto/auxiliar_files/**/*", "backend/**/*"]
...
codepipeline_tf_pr_name                     = "codepipeline-tf-pr-dev"
...
codepipeline_tf_pr_stages = [
  {
    ...
    action = [{
      ...
      # },
      {
        ...
        provider         = "CodeBuild"
        input_artifacts  = ["SourceOutput"]
        output_artifacts = ["SASTBACKArtifact"]
        version          = "1"
        run_order        = 1
        configuration = {
          ProjectName = "codebuild-tf-sast-back"
        }
      }
    ]
  },
...
codepipeline_tf_pr_trigger_git_conf_pull_request_file_paths_includes = ["infra/infra_auto/environments/dev/*", "infra/infra_auto/environment_template/*", "infra/infra_auto/auxiliar_files/**/*", "backend/**/*"]
...
codepipeline_tf_tag_enable_module            = false
codepipeline_tf_tag_name                     = "codepipeline-tf-tag-dev"
...
codepipeline_tf_tag_trigger_git_conf_push_tags_includes               = ["XXXXXXXXXXXXXXX"]
